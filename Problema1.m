...
t=0:0.002:4;%va afisa cele 2 perioade.
f=0.5;
w=2*pi*f;
duty=25;
nivel=0.25;
...
%procent - este folosit pentru a afisa procentul din amplitudine pe care il dorim.

%Pentru rezolutie temporara de 20 ms.
t=0:0.02:4;%va afisa 2 perioade.
f=0.5;
w=2*pi*f;
duty=25;
nivel=0.25;
